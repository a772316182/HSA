BEST_CONFIGS = {
    "node_classification": {
        'RGCN': {
            ...
            'ohgbn-Freebase': {
                'lr': 0.005, 'weight_decay': 0.0001, 'hidden_dim': 32, 'n_bases': 40, 'num_layers': 2,
                'batch_size': 256,
        ...
        'CompGCN': {
            ...
            'ohgbn-Freebase': {
                'lr': 0.01, 'weight_decay': 0.0001, 'dropout': 0.2, 'seed': 0, 'num_layers': 2, 'in_dim': 32,
                'hidden_dim': 32, 'out_dim': 32, 'max_epoch': 500, 'patience': 100, 'comp_fn': 'sub',
                'validation': True, 'fanout': 5, 'batch_size': 128, 'mini_batch_flag': True, 'use_uva': True
            },
            'alircd_session1': {
                'lr': 0.01, 'weight_decay': 0.0001, 'dropout': 0.2, 'seed': 0, 'num_layers': 2, 'in_dim': 32,
                'hidden_dim': 32, 'out_dim': 32, 'max_epoch': 500, 'patience': 100, 'comp_fn': 'sub',
        ...
        'SimpleHGN': {
            ...
            'ohgbn-Freebase': {
                'lr': 0.001, 'hidden_dim': 128, 'dropout': 0.16263095198267938, 'num_heads': 4,
                'feats_drop_rate': 0.13286688066111216, 'edge_dim': 32
            },

        },
        'RGAT': {
            'general': {
                'in_dim': 64, 'num_layers': 1, 'hidden_dim': 64, 'patience': 100, 'seed': 0, 'lr': 0.01,
                'weight_decay': 5e-4, 'max_epoch': 350, 'dropout': 0.2, 'num_heads': 3, 'out_dim': 3
            },
        ...
        'RSage': {
            'general': {'in_dim': 64, 'num_layers': 3, 'hidden_dim': 64, 'patience': 100, 'seed': 0, 'lr': 0.01,
                        'weight_decay': 5e-4, 'max_epoch': 350, 'dropout': 0.2, 'aggregator_type': 'pool',
                        'out_dim': 3},
            'alircd_session1': {'fanout': 5, 'batch_size': 128, 'mini_batch_flag': True, 'use_uva': True}
        },
        'HetSANN': {
            'general': {'lr': 0.0001, 'weight_decay': 0.0005, 'dropout': 0.2, 'seed': 0, 'hidden_dim': 64,
                        'num_layers': 2, 'num_heads': 16, 'max_epoch': 10000, 'patience': 100, 'slope': 0.2,
                        'residual': True, 'mini_batch_flag': True, 'batch_size': 2048, 'fanout': 5, 'use_uva': True},
            'ohgbn-Freebase': {'lr': 0.001, 'hidden_dim': 128, 'dropout': 0.33, 'num_heads': 8},
            'alircd_session1': {'lr': 0.01, 'hidden_dim': 32, 'dropout': 0.19},
        },
        'ieHGCN': {
            'general': {'num_layers': 5, 'hidden_dim': 64, 'attn_dim': 32, 'out_dim': 16, 'patience': 100, 'seed': 0,
                        'lr': 0.001, 'weight_decay': 5e-4, 'max_epoch': 3500, 'mini_batch_flag': True, 'fanout': 10,
                        'batch_size': 512, 'dropout': 0.2, 'bias': True, 'batchnorm': True},
    ...
    "link_prediction": {
        ...
        'TransE': {
            ...
            'FB15k': {
                'lr': 1, 'weight_decay': 0.0001, 'hidden_dim': 400, 'neg_size': 13, 'margin': 4, 'batch_size': 100,
                'valid_percent': 0.01, 'test_percent': 0.1
            },
            'wn18': {
                ...
                'lr': 1, 'weight_decay': 0.0001, 'hidden_dim': 400, 'neg_size': 100, 'margin': 50, 'batch_size': 100,
                'dis_norm': 2, 'patience': 3, 'valid_percent': 0.05, 'test_percent': 0.05
            }
        },
        'TransH': {
            'general': {
            ...
            'FB15k': {
                'lr': 1, 'weight_decay': 0.0001, 'hidden_dim': 400, 'neg_size': 15, 'margin': 5, 'batch_size': 100,
                'valid_percent': 0.01, 'test_percent': 0.1
            },
            'wn18': {
                'lr': 0.71, 'weight_decay': 0.0001, 'hidden_dim': 200, 'neg_size': 100, 'margin': 32.8,
                'batch_size': 100, 'patience': 5, 'valid_percent': 1, 'test_percent': 1
            }
        },
        'TransD': {
            'general': {
            ...
            'FB15k': {
                'lr': 0.6, 'weight_decay': 0.0001, 'ent_dim': 400, 'rel_dim': 400, 'neg_size': 20, 'margin': 5,
                'batch_size': 100, 'patience': 3, 'valid_percent': 0.01, 'test_percent': 0.1,
            },
            'wn18': {
                'lr': 0.5, 'weight_decay': 0.0001, 'ent_dim': 400, 'rel_dim': 400, 'neg_size': 98, 'margin': 200,
                'batch_size': 100, 'patience': 5, 'valid_percent': 1, 'test_percent': 1
            }
        }
