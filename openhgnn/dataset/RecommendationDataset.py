...
class KGAT_recommendation(RecommendationDataset):
    ...
    def download(self):
        ...
        # load pretrain file
        prefix = (
            "https://raw.githubusercontent.com/xiangwang1223/knowledge_graph_attention_network/master/Model/pretrain")
    ...
    def save(self):
        ...
        info_dict = {'n_users': self.n_users, 'n_entities': self.n_entities, 'n_relations': self.n_relations,
                     'n_items': self.n_items,
                     'train_user_dict': self.train_user_dict, 'test_user_dict': self.test_user_dict,
