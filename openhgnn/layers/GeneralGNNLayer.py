...
class GATConv(nn.Module):
    def __init__(self, dim_in, dim_out, bias=False, **kwargs):
        ...
        self.model = dgl.nn.pytorch.GATConv(dim_in, dim_out, num_heads=kwargs['num_heads'], bias=bias,
...
class SimpleConv(nn.Module):
    def __init__(self, dim_in, dim_out, bias=False, **kwargs):
        ...
        self.model = SimpleHGNConv(dim_in, dim_in, int(dim_out / kwargs['num_heads']), kwargs['num_heads'],
                                   kwargs['num_etypes'], beta=0.0)
