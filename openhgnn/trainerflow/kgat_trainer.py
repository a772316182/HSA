...
class KGAT_Trainer(BaseFlow):
    def __init__(self, args):
        ...
        self.model.set_parameters(self.n_users, self.n_entities, self.n_relations, self.user_pre_embed,
                                  self.item_pre_embed)
    ...
    def train(self):
        ...
        for epoch in range(1, self.max_epoch + 1):
            ...
            for iter in range(1, n_kg_batch + 1):
                ...
                kg_batch_loss = self.model('calc_kg_loss', kg_batch_head, kg_batch_relation, kg_batch_pos_tail,
                                           kg_batch_neg_tail)
                ...
                print(
                    'KG Training: Epoch {:04d} Iter {:04d} / {:04d} | Time {:.1f}s | Iter Loss {:.4f} | Iter Mean Loss {:.4f}'
            ...
            # evaluate cf
            time1 = time()
            _, precision, recall, ndcg = self.evaluate(self.model, self.g, self.train_user_dict, self.test_user_dict,
                                                       self.user_ids_batches, self.item_ids, self.args.K)
