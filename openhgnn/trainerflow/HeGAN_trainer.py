...
class HeGANTrainer(BaseFlow):
    ...
    def __init__(self, args):
        ...
        self.optim_dis = torch.optim.Adam(self.model.discriminator.parameters(), lr=args.lr_dis,
    ...
    def train(self):
        ...
        for epoch in epoch_iter:
            ...
            print(epoch)
            print(
                "discriminator:\n\tloss:{:.4f}\n\tmicro_f1: {:.4f},\n\tmacro_f1: {:.4f}".format(dis_loss, dis_score[0],
                                                                                                dis_score[1]))
            print("generator:\n\tloss:{:.4f}\n\tmicro_f1: {:.4f},\n\tmacro_f1: {:.4f}".format(gen_loss, gen_score[0],
                                                                                              gen_score[1]))
    ...
    def _full_train_step(self):
        ...
        for _ in range(self.args.epoch_dis):
            ...
            noise_emb = {
                et: torch.tensor(
                    np.random.normal(0.0, self.args.sigma, (pos_hg2.num_edges(et), self.args.emb_size)).astype(
            ...
            pos_score, neg_score1, neg_score2 = self.model.discriminator(pos_hg, pos_hg1, pos_hg2,
        ...
        for _ in range(self.args.epoch_gen):
            ...
            noise_emb = {
                et: torch.tensor(
                    np.random.normal(0.0, self.args.sigma, (gen_hg.num_edges(et), self.args.emb_size)).astype(
                        'float32')).to(self.device)
