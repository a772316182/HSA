...
class HGT(BaseModel):
    ...
    def build_model_from_args(cls, args, hg):
        ...
        for etype in hg.etypes:
            ...
            hg.edges[etype].data['id'] = th.ones(hg.number_of_edges(etype), dtype=th.long).to(args.device) * edge_dict[
                etype]
        return cls(node_dict, edge_dict, args.hidden_dim, args.out_dim, args.num_layers, args.num_heads, args.dropout,
                   category=args.category)

    def __init__(self, node_dict, edge_dict, hidden_dim, out_dim, num_layers, n_heads, dropout, category,
                 use_norm=True):
