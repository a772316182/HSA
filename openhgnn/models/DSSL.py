...
class DSSL(BaseModel):
    ...
    def build_model_from_args(cls, args, hg):
        ...
        return cls(encoder, args.hidden_channels, args.dataset, args.device, args.cluster_num, args.alpha, args.gamma,
                   args.tao,
                   args.beta, args.tau)

    def __init__(self, encoder, hidden_channels, dataset, device, cluster_num, alpha, gamma, tao, beta,
