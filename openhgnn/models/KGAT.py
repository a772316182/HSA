...
class KGAT(BaseModel):
    ...
    def __init__(self, args):
        ...
        for k in range(self.n_layers):
            self.aggregator_layers.append(
                KGAT_Aggregator(self.conv_dim_list[k], self.conv_dim_list[k + 1], self.mess_dropout[k],
    ...
    def calc_kg_loss(self, h, r, pos_t, neg_t):  # f
        ...
        l2_loss = self._L2_loss_mean(r_mul_h) + self._L2_loss_mean(r_embed) + self._L2_loss_mean(
            r_mul_pos_t) + self._L2_loss_mean(r_mul_neg_t)
    ...
    def calc_cf_loss(self, mode, g, user_ids, item_pos_ids, item_neg_ids):
        ...
        l2_loss = self._L2_loss_mean(user_embed) + self._L2_loss_mean(item_pos_embed) + self._L2_loss_mean(
            item_neg_embed)
